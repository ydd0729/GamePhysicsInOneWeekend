...
void Application::MouseMoved(float x, float y)
{
    ...
    m_cameraPositionTheta = std::max(m_cameraPositionTheta, 0.14f);
    m_cameraPositionTheta = std::min(m_cameraPositionTheta, 3.0f);
}
