...
bool PhysicalDeviceProperties::AcquireProperties(VkPhysicalDevice device, VkSurfaceKHR vkSurface)
{
    ...
    {
        uint32_t numFormats;
        result = vkGetPhysicalDeviceSurfaceFormatsKHR(m_vkPhysicalDevice, vkSurface, &numFormats, nullptr);
    ...
    // VkPresentModeKHR
    {
        ...
        result = vkGetPhysicalDeviceSurfacePresentModesKHR(m_vkPhysicalDevice, vkSurface, &numPresentModes, nullptr);
    ...
    // VkExtensionProperties
    {
        ...
        result = vkEnumerateDeviceExtensionProperties(m_vkPhysicalDevice, nullptr, &numExtensions, nullptr);
        ...
        result = vkEnumerateDeviceExtensionProperties(m_vkPhysicalDevice, nullptr, &numExtensions,
...
bool DeviceContext::CreatePhysicalDevice()
{
    ...
    //
    {
        ...
        result = vkEnumeratePhysicalDevices(m_vkInstance, &numDevices, nullptr);
    ...
    for (int i = 0; i < m_physicalDevices.size(); i++)
    {
        ...
        if (!deviceProperties.HasExtensions((const char**)m_deviceExtensions.data(),
                                            static_cast<int>(m_deviceExtensions.size())))
        {
            continue;
        }
